...
@section('page-title', 'Add Study Link - {{ $unit->code }}')
...
<div class="form-container">
    ...
    <div class="form-card">
        <div class="form-header">
            <h2><i class="fas fa-plus-circle"></i> Add New Study Link</h2>
            <p style="color: #64748b; margin-top: 5px;">Save useful resources for {{ $unit->code }}</p>
        </div>

        <form method="POST" action="{{ route('links.store', $unit->code) }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       name="title" 
                       value="{{ old('title') }}" 
                       placeholder="e.g., YouTube Tutorial on Topic X"
                       required>
                @error('title')
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <input type="radio" 
                               ...
                               name="type" 
                               value="youtube" 
                               {{ old('type', 'youtube') == 'youtube' ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-textarea @error('description') is-invalid @enderror" 
                          ...
                          name="description" 
                          rows="4" 
                          placeholder="Add notes about why this link is useful...">{{ old('description') }}</textarea>
                @error('description')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
...
<script>
    ...
    // Run on page load to show preview if there's an old value

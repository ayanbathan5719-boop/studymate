...
@section('content')
    ...
    <div class="form-container">
        ...
        <form action="/admin/units" method="POST" data-persist="true">
            @csrf
            ...
            <div class="form-group">
                ...
                @if($courses->isEmpty())
                    <div class="help-text">
                        <i class="fas fa-info-circle"></i> No courses available. <a href="/admin/courses/create">Create a course first</a>
                    </div>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if($lecturers->isEmpty())
                    <div class="help-text">
                        <i class="fas fa-info-circle"></i> No lecturers available. You can leave this empty and assign later.
                    </div>
                @endif
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save" style="margin-right: 8px;"></i> Create Unit
                </button>

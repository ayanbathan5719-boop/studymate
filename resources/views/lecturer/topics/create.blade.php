...
@section('page-title', 'Create New Topic - ' . $unit->name)
...
<div class="create-container">
    ...
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('lecturer.topics.store', $unit->code) }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          id="description" 
                          name="description" 
                          placeholder="Brief overview of what this topic covers...">{{ old('description') }}</textarea>
                @error('description')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div id="videoPreview" class="video-preview">
                    ...
                    <div id="videoPreviewInfo" class="video-preview-info"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" 
                          ...
                          name="content" 
                          rows="8"
                          placeholder="Write the main content for this topic...">{{ old('content') }}</textarea>
                @error('content')
                    <span class="error-message">{{ $message }}</span>
                @enderror
                <div class="help-text">
            ...
            <div class="form-group">
                ...
                <div class="status-toggle">
                    <div class="status-option">
                        <input type="radio" name="status" id="status_draft" value="draft" {{ old('status', 'draft') == 'draft' ? 'checked' : '' }}>
                    ...
                    <div class="status-option">
                        <input type="radio" name="status" id="status_published" value="published" {{ old('status') == 'published' ? 'checked' : '' }}>
                ...
                @enderror
                <div class="help-text">
                    <i class="fas fa-info-circle"></i> Draft topics are only visible to you
                </div>
            </div>

...
@section('page-title', 'Create New Deadline')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Create Deadline</li>
        </ol>
    </nav>
@endsection
...
<div class="create-container">
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('lecturer.deadlines.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="type-selector">
                    <div class="type-option">
                        <input type="radio" name="type" id="type_general" value="general" {{ old('type', 'general') == 'general' ? 'checked' : '' }}>
                    ...
                    <div class="type-option">
                        <input type="radio" name="type" id="type_topic" value="topic" {{ old('type') == 'topic' ? 'checked' : '' }}>
                    ...
                    <div class="type-option">
                        <input type="radio" name="type" id="type_assignment" value="assignment" {{ old('type') == 'assignment' ? 'checked' : '' }}>
            ...
            <div id="topicContainer" class="topic-select-container {{ old('type') != 'topic' ? 'hidden' : '' }}">
                <div class="form-group">
                    <label for="topic_id">
                    ...
                    <select name="topic_id" 
                        ...
                        @if($selectedUnit && $topics->count() > 0)
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          id="description" 
                          name="description" 
                          placeholder="Provide details about this deadline...">{{ old('description') }}</textarea>
                @error('description')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Create Deadline
                </button>
            </div>
        </form>
    </div>
...
<script>
    ...
    unitSelect.addEventListener('change', function() {
        ...
        if (unitId && document.querySelector('input[name="type"]:checked')?.value === 'topic') {
    ...
    // Initial load if unit is pre-selected
    if (unitSelect.value && document.querySelector('input[name="type"]:checked')?.value === 'topic') {
